mapboxgl.accessToken = "pk.eyJ1IjoibmluZXZlaG9tYXAiLCJhIjoiY2w5d3R3NHVrMDBqZDNxcWxrMGt3Y21wMSJ9.F3_lqP-kbMq1X8N-xVWrlg";
...
// create a map.on mouse move event for “landUse” layers
...
const popup = new mapboxgl.Popup({
  ...
  const submitForm = (location) => {
    ...
    // name
    submission[6] = newPoint.properties.name;
    // email
